...
def summary(df:pd.DataFrame,base_body:BaseBody):
    ...
    res = pd.DataFrame(index=middle_df.index,
                       columns=["breakfast_avg_count", "breakfast_avg_amount", "lunch_avg_count", "lunch_avg_amount",
                                "dinner_avg_count", "dinner_avg_amount"], dtype=float)
