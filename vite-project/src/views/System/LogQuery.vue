...
const mockLogs = [
  {
    id: 'LOG202401150001',
    operationTime: '2024-01-15 09:30:22',
    operator: 'admin',
    operationType: 'login',
    ...
    responseResult: { token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9' }
  },
  {
    id: 'LOG202401150002',
    ...
    operationType: 'query',
    module: 'student_info',
    operationDetail: '查询学生信息列表',
    ipAddress: '192.168.1.101',
    result: 'success',
    executionTime: 450,
    requestParams: { college: '01', page: 1, size: 10 },
    responseResult: { total: 150, list: [] }
  },
  {
    id: 'LOG202401150003',
    ...
    operator: 'teacher_li',
    operationType: 'query',
    module: 'consumption_query',
    operationDetail: '查询学生消费记录',
    ipAddress: '192.168.1.102',
    result: 'success',
    executionTime: 320,
    requestParams: { studentId: '2021001001', dateRange: ['2024-01-01', '2024-01-15'] }
  },
  {
    id: 'LOG202401150004',
    operationTime: '2024-01-15 14:05:44',
    operator: 'admin',
    operationType: 'update',
    module: 'student_info',
    operationDetail: '修改学生信息',
    ipAddress: '192.168.1.100',
    result: 'success',
    executionTime: 280,
    requestParams: { studentId: '2021001001', name: '张三', phone: '13800138000' }
  },
  {
    id: 'LOG202401150005',
    operationTime: '2024-01-15 15:30:18',
    operator: 'teacher_wang',
    operationType: 'export',
    module: 'poverty_identification',
    operationDetail: '导出贫困生鉴别结果',
    ipAddress: '192.168.1.103',
    result: 'failure',
    executionTime: null,
    requestParams: { algorithm: 'kmeans', threshold: 0.8 }
  },
  {
    id: 'LOG202401150006',
    operationTime: '2024-01-15 16:45:29',
    operator: 'teacher_zhao',
    operationType: 'query',
    module: 'score_correlation',
    operationDetail: '分析成绩与消费关联性',
    ipAddress: '192.168.1.104',
    result: 'success',
    executionTime: 1560,
    requestParams: { semester: '2023-2', correlationType: 'pearson' }
  },
  {
    id: 'LOG202401150007',
    operationTime: '2024-01-15 17:20:11',
    operator: 'admin',
    operationType: 'delete',
    module: 'system_management',
    operationDetail: '删除过期日志记录',
    ipAddress: '192.168.1.100',
    result: 'success',
    executionTime: 890,
    requestParams: { beforeDate: '2023-12-31' }
  }
]
...
const loadLogData = async () => {
  ...
  try {
    ...
    if (queryForm.operationType) {
      filteredLogs = filteredLogs.filter(log => log.operationType === queryForm.operationType)
    }

    // 按操作人员过滤
    if (queryForm.operator) {
      filteredLogs = filteredLogs.filter(log =>
          log.operator.toLowerCase().includes(queryForm.operator.toLowerCase())
      )
    }
    ...
    // 按结果过滤
    if (queryForm.result) {
      filteredLogs = filteredLogs.filter(log => log.result === queryForm.result)
    }

    // 按IP地址过滤
    if (queryForm.ipAddress) {
      filteredLogs = filteredLogs.filter(log => log.ipAddress.includes(queryForm.ipAddress))
    }
    ...
    if (queryForm.timeRange && queryForm.timeRange.length === 2) {
      ...
      filteredLogs = filteredLogs.filter(log => {
        const logDate = log.operationTime.split(' ')[0]
